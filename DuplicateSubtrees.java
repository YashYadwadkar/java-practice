...
class Solution {
    public List<Node> printAllDups(Node root) {
        ...
        public String help(Node root, ArrayList<Node> al, HashMap<String,Integer>hm){
        if(root==null)return "*";
        String data= root.data+" "+help(root.left,al,hm)+" "+help(root.right,al,hm);
        
        hm.put(data,hm.getOrDefault(data,0)+1);
        if(hm.get(data)==2)al.add(root);
